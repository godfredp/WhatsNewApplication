...
const DefaultLayout = ({ children }) => {
  ...
  useEffect(() => {
    setState({
      ...
      steps: [
        {
          content: <div>Checkout our newly added features</div>,
          disableBeacon: true,
        ...
        {
          content:
            "You can start adding leads to your team by pressing this button!",
          placement: "right",
          styles: {
            options: {
              zIndex: 10000,
  ...
  return (
    <div>
      ...
      <div className="p-[20px] bg-white">{children}</div>
    </div>
  );
};
